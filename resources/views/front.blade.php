...
@section('content')<div class="site-section" id="features-section">
  ...
  <div class="accordion" id="accordionExample">
          ...
          <div class="col-md-5 col-lg-5 mb-4 mb-lg-4 myplan" >
           <div class="select_plan" style=" position: absolute; ">
                ...
                <option class="input-group"  value="0" selected="" >Please select your plan</option>
                <option class="input-group"  value="1" >1 Month subscription GH₵200</option>
                 <option class="input-group" value="2" >3 Months subscription GH₵300</option>
                 <option class="input-group" value="3" >6 Months subscription GH₵500</option>
                 <option class="input-group" value="4" >1 year subscription GH₵650</option>
                 </select>

                  <a href=""><div id="durdropsubmit" class="mt-3 btn" >Subscribe</div></a>
    ...
    {{-- <section>
    <div>
        <b-jumbotron header="Lessons" lead="Browse all lessons">
